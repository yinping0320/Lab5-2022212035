...
import { StudentListRoutingModule } from './routing';
...
var StudentListModule = /** @class */ (function () {
    function StudentListModule(trans) {
        this.trans = trans;
    }
    StudentListModule = tslib_1.__decorate([
        NgModule({
            ...
            providers: [
                ...
                FileViewerService,
                { provide: FORM_PATH_TOKEN, useValue: '/apps/apporder/df/web/bo-student-front/studentlist/' },
...
export function createTranslateLoader(http) {
    return new TranslateHttpLoader(http, '/apps/apporder/df/web/bo-student-front/studentlist/i18n/', '.json');
}
export { ɵ0, ɵ1, ɵ2 };
