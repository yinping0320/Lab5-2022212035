...
import { JobinfoComponentViewmodel } from './jobinfocomponentviewmodel';

import { EduinfoComponentViewmodel } from './eduinfocomponentviewmodel';
...
export class RootViewmodel extends ViewModel {
    ...
    public jobinfoComponentViewmodel: JobinfoComponentViewmodel;
    public eduinfoComponentViewmodel: EduinfoComponentViewmodel;
    @NgCommand({
        name: 'Load1',
        params: {
