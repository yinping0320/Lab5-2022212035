...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        const states = {
                'jobinfoAddButton': !this.viewModel.stateMachine['canAddDetail'],
                'jobinfoRemoveButton': !this.viewModel.stateMachine['canRemoveDetail'],
                'eduinfoAddButton': !this.viewModel.stateMachine['canAddDetail'],
                'eduinfoRemoveButton': !this.viewModel.stateMachine['canRemoveDetail'],
        }; 
        ...
        contents: [
            {
                ...
                visible: true,
                title: this.langService.transform('jobinfoAddButton', this.lang, "新增"),
                click: () => { this.viewModel.jobinfoComponentViewmodel.jobinfoAddItem1(); },
                appearance: {
            ...
            },
            {
                ...
                visible: true,
                title: this.langService.transform('jobinfoRemoveButton', this.lang, "删除"),
                click: () => { this.viewModel.jobinfoComponentViewmodel.jobinfoRemoveItem1(); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            }
        ...
        contents: [
            {
                ...
                disable: !this.viewModel.stateMachine['canAddDetail'],
                visible: true,
                title: this.langService.transform('eduinfoAddButton', this.lang, "新增"),
                click: () => { this.viewModel.eduinfoComponentViewmodel.eduinfoAddItem1(); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            },
            {
                ...
                disable: !this.viewModel.stateMachine['canRemoveDetail'],
                visible: true,
                title: this.langService.transform('eduinfoRemoveButton', this.lang, "删除"),
                click: () => { this.viewModel.eduinfoComponentViewmodel.eduinfoRemoveItem1(); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            }
    ...
    jobinfotabpage = this.langService.transform('jobinfo-tab-page', this.lang, "工作信息");
    eduinfotabpage = this.langService.transform('eduinfo-tab-page', this.lang, "教育信息");
