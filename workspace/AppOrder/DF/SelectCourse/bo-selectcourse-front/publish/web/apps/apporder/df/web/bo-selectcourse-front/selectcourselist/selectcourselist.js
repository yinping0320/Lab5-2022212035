    ...
    return {
        ...
        execute: function () {
            ...
            function createTranslateLoader(http, version) {
                ...
                return new TranslateHttpLoader(http, '/apps/apporder/df/web/bo-selectcourse-front/selectcourselist/i18n/', '.json' + versionSuffix);
            }
            var lang = { "zh-CHS": { "root-component": "", "root-layout": "", "query-scheme-section": "", "Section/query-scheme-section/mainTitle": "主标题", "Section/query-scheme-section/subTitle": "", "query-scheme-1": "默认筛选方案", "QueryScheme/query-scheme-1/filterText": "筛选", "QueryScheme/query-scheme-1/6f9e4199-b324-42a5-808b-2704ae2992cf": "选课信息Id", "QueryScheme/query-scheme-1/6f9e4199-b324-42a5-808b-2704ae2992cf/placeHolder": "", "page-header": "", "header-nav": "", "header-title-container": "", "page-header-title": "", "title": "选课列表", "page-header-toolbar": "", "button-add": "新增", "button-edit": "编辑", "button-view": "查看", "button-delete": "删除", "page-main": "", "data-grid-component-ref": "", "data-grid-component": "", "data-grid-section": "", "Section/data-grid-section/mainTitle": "", "Section/data-grid-section/subTitle": "", "dataGrid": "", "DataGrid/dataGrid/lineNumberTitle": "", "DataGrid/dataGrid/OperateEditButton": "编辑", "DataGrid/dataGrid/OperateDeleteButton": "删除", "DataGrid/dataGrid/OperateColumn": "操作", "selectedId_6f9e4199_386r": "选课信息Id" } };
                    ...
                    if (langCode == "zh-CHS" || (this.translate.defaultLang === langCode && this.translate.currentLoader == createTranslateLoader(this.http, null))) {
                        ...
                        var httpOb = this.http.get("/apps/apporder/df/web/bo-selectcourse-front/version.json?v=" + new Date().getTime()).pipe(switchMap(function (data) {
                            ...
                            if (data instanceof Array) {
                                var versionKey_1 = "selectcourselist/" + langCode + ".json";
            ...
            var RootViewmodel = /** @class */ (function (_super) {
                ...
                __decorate([
                    NgCommand({
                        name: 'Add1',
                        params: {
                            url: '7fa4d38d-ba79-4bfd-bbbf-c82b44967bb7',
                    ...
                    _this.fieldConfigsqueryscheme1 = [
                        {
                            ...
                            "code": "SelectedId",
                            "name": _this.langService.transform('QueryScheme/query-scheme-1/6f9e4199-b324-42a5-808b-2704ae2992cf', _this.lang, "选课信息Id"),
                            "placeHolder": _this.langService.transform('QueryScheme/query-scheme-1/6f9e4199-b324-42a5-808b-2704ae2992cf/placeHolder', _this.lang, ""),
                            "control": { "id": "6f9e4199-b324-42a5-808b-2704ae2992cf", "controltype": "text", "require": false, "className": "" }
                        }
                    ];
                ...
                RootComponent = __decorate([
                    Component({
                        ...
                        providers: [
                            ...
                            { provide: FORM_ID, useValue: "45bc7d62-95fe-4739-9ebb-2e6e813f4980" },
            ...
            var SelectCourseListRoutingModule = /** @class */ (function () {
                function SelectCourseListRoutingModule() {
                }
                SelectCourseListRoutingModule = __decorate([
                    NgModule({
                        imports: [
                ...
                ], SelectCourseListRoutingModule);
                return SelectCourseListRoutingModule;
            }());
                        ...
                        [
                            {
                                ...
                                field: 'selectedId',
                                width: 120,
                                title: this.langService.transform('selectedId_6f9e4199_386r', this.lang, "选课信息Id"),
                                dataType: 'string',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
            ...
            var SelectCourseListModule = /** @class */ (function () {
                function SelectCourseListModule(trans) {
                    this.trans = trans;
                }
                SelectCourseListModule = __decorate([
                    NgModule({
                        exports: [
                            RootComponent
                        ],
                        ...
                        providers: [
                            ...
                            FrmI18nSettingService,
                            FileViewerService,
                            { provide: FORM_PATH_TOKEN, useValue: '/apps/apporder/df/web/bo-selectcourse-front/selectcourselist/' },
                            { provide: BE_SERVER_URI_TOKEN, useFactory: ɵ2$1 }
                        ]
                    }),
                    __metadata("design:paramtypes", [TranslateResolveService])
                ], SelectCourseListModule);
                return SelectCourseListModule;
            }());
            function createTranslateLoader$1(http) {
                return new TranslateHttpLoader(http, '/apps/apporder/df/web/bo-selectcourse-front/selectcourselist/i18n/', '.json');
            }
            ...
            function View_RootComponent_3(_l) { return ɵvid(0, [(_l()(), ɵeld(0, 0, null, null, 5, "farris-querysolution", [["farris-querysolution-event-bind", ""], ["id", "query-scheme-1"]], [[8, "className", 0]], [[null, "queryEmitter"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("queryEmitter" === en)) {
                    ...
                    ad = (pd_1 && ad);
                } return ad; }, View_QuerySolutionComponent_0, RenderType_QuerySolutionComponent)), ɵprd(512, null, ConvertorService, ConvertorService, []), ɵprd(512, null, ɵa$1, ɵa$1, [HttpClient]), ɵprd(512, null, ɵb$2, ɵb$2, []), ɵdid(4, 770048, null, 0, QuerySolutionComponent, [NotifyService, ComponentFactoryResolver, Injector, BsModalService, ConvertorService, SolutionService, ɵa$1, ɵb$2, LocaleService], { fieldConfigs: [0, "fieldConfigs"], presetQuerySolutionName: [1, "presetQuerySolutionName"], presetFieldConfigs: [2, "presetFieldConfigs"], isDisabled: [3, "isDisabled"], formId: [4, "formId"], isFold: [5, "isFold"], isControlInline: [6, "isControlInline"], showCompleteLabel: [7, "showCompleteLabel"], enableInitQuery: [8, "enableInitQuery"], enableHistory: [9, "enableHistory"] }, { queryEmitter: "queryEmitter" }), ɵdid(5, 16384, null, 0, FarrisQuerySolutionEventBindDirective, [Injector, QuerySolutionComponent, FrameContext], null, null)], function (_ck, _v) { var _co = _v.component; var currVal_1 = _co.fieldConfigsqueryscheme1; var currVal_2 = _co.QuerySolutionqueryscheme1; var currVal_3 = _co.presetFieldConfigsqueryscheme1; var currVal_4 = false; var currVal_5 = "SelectCourseList"; var currVal_6 = !true; var currVal_7 = true; var currVal_8 = false; var currVal_9 = false; var currVal_10 = false; _ck(_v, 4, 0, currVal_1, currVal_2, currVal_3, currVal_4, currVal_5, currVal_6, currVal_7, currVal_8, currVal_9, currVal_10); }, function (_ck, _v) { var currVal_0 = ɵnov(_v, 4).cls; _ck(_v, 0, 0, currVal_0); }); }
