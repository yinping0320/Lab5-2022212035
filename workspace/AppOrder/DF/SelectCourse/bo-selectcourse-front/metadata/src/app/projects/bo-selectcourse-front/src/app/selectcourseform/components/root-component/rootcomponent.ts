...
import { SelectCourseProxy } from '../../models/selectcourseproxy';
...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        const states = {
                'studentsAddButton': !this.viewModel.stateMachine['canAddDetail'],
                'studentsRemoveButton': !this.viewModel.stateMachine['canRemoveDetail'],
                'coursesAddButton': !this.viewModel.stateMachine['canAddDetail'],
                'coursesRemoveButton': !this.viewModel.stateMachine['canRemoveDetail'],
        }; 
        ...
        contents: [
            {
                ...
                visible: true,
                title: this.langService.transform('studentsAddButton', this.lang, "新增"),
                click: () => { this.viewModel.studentsComponentViewmodel.studentsAddItem1(); },
                appearance: {
            ...
            },
            {
                ...
                visible: true,
                title: this.langService.transform('studentsRemoveButton', this.lang, "删除"),
                click: () => { this.viewModel.studentsComponentViewmodel.studentsRemoveItem1(); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            }
        ...
        contents: [
            {
                ...
                disable: !this.viewModel.stateMachine['canAddDetail'],
                visible: true,
                title: this.langService.transform('coursesAddButton', this.lang, "新增"),
                click: () => { this.viewModel.coursesComponentViewmodel.coursesAddItem1(); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            },
            {
                ...
                disable: !this.viewModel.stateMachine['canRemoveDetail'],
                visible: true,
                title: this.langService.transform('coursesRemoveButton', this.lang, "删除"),
                click: () => { this.viewModel.coursesComponentViewmodel.coursesRemoveItem1(); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            }
    ...
    studentstabpage = this.langService.transform('students-tab-page', this.lang, "学生");
    coursestabpage = this.langService.transform('courses-tab-page', this.lang, "课程");
