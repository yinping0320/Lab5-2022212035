...
import { SelectCourseFormRoutingModule } from './routing';
...
import { CoursesComponent } from './components/courses-component/coursescomponent';
...
var SelectCourseFormModule = /** @class */ (function () {
    ...
    SelectCourseFormModule = tslib_1.__decorate([
        NgModule({
            exports: [
                RootComponent
            ],
