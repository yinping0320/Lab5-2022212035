...
import { StudentsComponentViewmodel } from './studentscomponentviewmodel';

import { CoursesComponentViewmodel } from './coursescomponentviewmodel';
...
export class RootViewmodel extends ViewModel {
    ...
    public studentsComponentViewmodel: StudentsComponentViewmodel;
    public coursesComponentViewmodel: CoursesComponentViewmodel;
    @NgCommand({
        name: 'Load1',
        params: {
