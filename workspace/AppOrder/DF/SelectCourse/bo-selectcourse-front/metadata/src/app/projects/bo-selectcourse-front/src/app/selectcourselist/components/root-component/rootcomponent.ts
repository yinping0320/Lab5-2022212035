    ...
    fieldConfigsqueryscheme1 = [
        {
            ...
            "code": "SelectedId",
            "name": this.langService.transform('QueryScheme/query-scheme-1/6f9e4199-b324-42a5-808b-2704ae2992cf', this.lang, "选课信息Id"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/6f9e4199-b324-42a5-808b-2704ae2992cf/placeHolder', this.lang, ""),
