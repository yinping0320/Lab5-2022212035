...
function Lazy () {
  return class Lazy {
    ...
    _addListenerTarget(el) {
      if (!el) return;
      var target = this.TargetQueue.find(target => target.el === el);
...
var LazyComponent = (lazy => ({
  ...
  methods: {
    ...
    checkInView() {
      this.getRect();
      return use.inBrowser && this.rect.top < window.innerHeight * lazy.options.preLoad && this.rect.bottom > 0 && this.rect.left < window.innerWidth * lazy.options.preLoad && this.rect.right > 0;
    },
...
var LazyImage = (lazyManager => ({
  ...
  methods: {
    ...
    checkInView() {
      this.getRect();
      return use.inBrowser && this.rect.top < window.innerHeight * lazyManager.options.preLoad && this.rect.bottom > 0 && this.rect.left < window.innerWidth * lazyManager.options.preLoad && this.rect.right > 0;
    },
