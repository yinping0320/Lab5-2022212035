(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@gspwidget/gridster', ['exports', '@angular/common', '@angular/core'], factory) :
    (factory((global.gspwidget = global.gspwidget || {}, global.gspwidget.gridster = {}),global.ng.common,global.ng.core));
    ...
    ***************************************************************************** */
         ...
         */
            function () {
                ...
                if (this.options.gridHeightReal) {
                    /** @type {?} */
                    var mostBottomValue_1 = 0;
                    this.grid.forEach(( /**
                     * @param {?} item
                     * @return {?}
                     */function (item) {
                        if (item.top + item.height > mostBottomValue_1) {
                            mostBottomValue_1 = Math.ceil(item.top + item.height);
                        }
                    }));
                    mostBottomValue_1 += this.options.margin * 2 + 1;
                    this.options.afterCalculateLayout(mostBottomValue_1);
                    this.renderer.setStyle(this.el, 'height', mostBottomValue_1 + 'px');
                }
            };
        /**
         * @return {?}
    ...
    var GridsterItemComponent = /** @class */ (function () {
        function GridsterItemComponent(el, gridster, renderer, zone) {
            ...
            // add by tx
            this.onItemInit = new core.EventEmitter();
            this.el = el.nativeElement;
            this.$item = {
                cols: -1,
                rows: -1,
...
//# sourceMappingURL=gspwidget-gridster.umd.js.map