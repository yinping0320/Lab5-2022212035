...
import { WidgetContainerMode, appendScript, PlThemeColors, UtilModule, IGIX_HOME_PATH, loadCommonStyleNTheme, EppPortlet, FILTERS_WIDGET_PROP_NAME, FILTERS_WIDGET_NAME, RuntimeAggOption, deepClone, Indicator, ArrUtil, objectLiteralEqual } from '@gspwidget/util';
import * as WidgetDevkitModule$1 from '@gspwidget/widget-devkit';
import { WidgetPropertyService, WidgetRegistry, WidgetDevkitModule, FILTER_PROP_NAME, FilterSchema, WidgetInstanceInfo, WidgetDataService, WidgetEventService, FSEnum, JumpTypes, isFsFlat, ifFsDateRange, WidgetDevkitService } from '@gspwidget/widget-devkit';
...
import { ComponentFactoryResolver, Injectable, Injector, NgModule, Component, EventEmitter, Input, Output, Pipe, ChangeDetectionStrategy, ContentChild, defineInjectable, inject, INJECTOR, ChangeDetectorRef, ViewChild, ViewContainerRef } from '@angular/core';
...
var DynamicLoaderService$$1 = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = mode;
                        switch (_a) {
                            case WidgetContainerMode.AOT: return [3 /*break*/, 1];
                            case WidgetContainerMode.DEV: return [3 /*break*/, 4];
                        }
                        return [3 /*break*/, 5];
                    case 1: 
                    // 加载 widget js 文件
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 5];
                    case 5:
                        widgetConfig = WidgetRegistry.getWidgetByName(widgetName);
    ...
    /** @nocollapse */
    DynamicLoaderService$$1.ctorParameters = function () { return [
        { type: Injector },
        { type: HttpClient },
...
function getWidgetComponentFactory(widgetName, systemModule) {
    /** @type {?} */
    var componentType = WidgetRegistry.getWidgetByName(widgetName).ctor;
    if (componentType) {
...
var TitleBarComponent = /** @class */ (function () {
    ...
    function (changes) {
        if (changes.filterConfigs) {
             ...
             * @return {?}
             */
            function (fc) { return !isFsFlat(fc.fs); }));
