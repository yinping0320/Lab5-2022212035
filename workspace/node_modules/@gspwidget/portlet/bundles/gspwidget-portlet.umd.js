(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common/http'), require('@gspwidget/util'), require('rxjs/operators'), require('@angular/common'), require('@angular/core'), require('@gspwidget/widget-core')) :
    typeof define === 'function' && define.amd ? define('@gspwidget/portlet', ['exports', '@angular/common/http', '@gspwidget/util', 'rxjs/operators', '@angular/common', '@angular/core', '@gspwidget/widget-core'], factory) :
    (factory((global.gspwidget = global.gspwidget || {}, global.gspwidget.portlet = {}),global.ng.common.http,global.util,global.rxjs.operators,global.ng.common,global.ng.core,global.widgetCore));
}(this, (function (exports,http,util,operators,common,core,widgetCore) { 'use strict';
    ...
    var PortletComponent = /** @class */ (function () {
        function PortletComponent(portletRepo, dataResultsetRepo, http$$1, cd) {
            var _this = this;
             ...
             */
            this.gotPortlet = new core.EventEmitter();
            this.getData = ( /**
             * @param {?} getDataOpts
             * @return {?}
             */function (getDataOpts) {
                ...
                if (_this.getCustomizedData) {
                    ...
                    // // 若名中含有某些字，则用演示数据
                    return _this.getCustomizedData().pipe(operators.delay(0));
                }
             ...
             */function (name) { return _this.innerPortlet.name.includes(name); }))) {
                    return _this.getDemoData().pipe(operators.delay(0));
                }
                else {
                    // 默认真数据
         ...
         */
            function (changes) {
                ...
                if (changes.portletId && changes.portletId.currentValue) {
                     ...
                     */function (err) {
                        // console.log(err)
                        _this.widget.status = widgetCore.WCStatus.WidgetLoadError;
                    }));
                }
         ...
         */
            ...
            function () {
                ...
                return this.getHomeConfig().pipe(operators.map(( /**
                 * @param {?} config
                 * @return {?}
        ...
        /** @nocollapse */
        PortletComponent.ctorParameters = function () {
            return [
                { type: util.PortletRepo },
                { type: util.DatasetRepo },
                { type: http.HttpClient },
                { type: core.ChangeDetectorRef }
            ];
        };
        PortletComponent.propDecorators = {
            portletId: [{ type: core.Input }],
            portlet: [{ type: core.Input }],
            queryConditions: [{ type: core.Input }],
            portletNamesUsingDemoData: [{ type: core.Input }],
            getCustomizedData: [{ type: core.Input }],
            instanceId: [{ type: core.Input }],
            linkMap: [{ type: core.Input }],
            init: [{ type: core.Output }],
            gotPortlet: [{ type: core.Output }],
            widget: [{ type: core.ViewChild, args: ['widget',] }]
        };
...
//# sourceMappingURL=gspwidget-portlet.umd.js.map