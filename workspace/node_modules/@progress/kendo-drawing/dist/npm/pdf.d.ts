...
/**
 * Exports a group of drawing elements as a PDF file ([see example](slug:pdfexport_drawing)). In the exported file, the group is positioned at `[0, 0]`. Its dimensions are used as the default dimensions for the image.
 *
 ...
 * {% meta %}
 * {% embed_file pdf-output/overview/export-scene.ts preview %}
 * {% embed_file pdf-output/overview/app.component.ts %}
 * {% embed_file pdf-output/overview/app.module.ts hidden %}
 * {% embed_file shared/main.ts hidden %}
 * {% endmeta %}
 * {% endplatform_content %}
 * {% platform_content react %}
 * {% meta %}
 * {% embed_file pdf-output/export-pdf/app.tsx preview %}
 * {% embed_file pdf-output/export-pdf/main.tsx %}
 * {% embed_file pdf-output/export-pdf/export-scene.js %}
 * {% endmeta %}
 * {% endplatform_content %}
...
/**
 * Exports the group of drawing elements and saves it. For more information on how to set up a server proxy, refer to the [Server Proxy](slug:server_proxy) article.
 *
 * @param group - The Group to export.
