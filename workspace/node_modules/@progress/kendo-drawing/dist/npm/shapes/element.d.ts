...
export abstract class Element {
   ...
   * {% meta %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-clip/draw-scene.ts %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-clip/app.component.ts %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-clip/app.module.ts hidden %}
   * {% embed_file shared/main.ts hidden %}
   * {% endmeta %}
   * {% endplatform_content %}
   * {% platform_content react %}
   * {% meta %}
   * {% embed_file element-clip/app.tsx preview %}
   * {% embed_file element-clip/main.tsx %}
   * {% embed_file element-clip/draw-scene.js %}
   * {% endmeta %}
   * {% endplatform_content %}
   *
   ...
   * {% platform_content angular %}
   * {% meta %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-clip-clear/draw-scene.ts %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-clip-clear/app.component.ts %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-clip-clear/app.module.ts hidden %}
   * {% embed_file shared/main.ts hidden %}
   * {% endmeta %}
   * {% endplatform_content %}
   * {% platform_content react %}
   ...
   * {% embed_file element-clip/app.tsx preview %}
   * {% embed_file element-clip/main.tsx %}
   * {% embed_file element-clip-clear/draw-scene.js %}
   * {% endmeta %}
   * {% endplatform_content %}
   *
   ...
   * {% platform_content angular %}
   * {% meta %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-opacity/draw-scene.ts %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-opacity/app.component.ts %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-opacity/app.module.ts hidden %}
   * {% embed_file shared/main.ts hidden %}
   * {% endmeta %}
   * {% endplatform_content %}
   * {% platform_content react %}
   * {% meta %}
   * {% embed_file element-opacity/app.tsx preview %}
   * {% embed_file element-opacity/main.tsx %}
   * {% embed_file element-opacity/draw-scene.js %}
   * {% endmeta %}
   * {% endplatform_content %}
   *
   ...
   * {% platform_content angular %}
   * {% meta %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-transform/draw-scene.ts %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-transform/app.component.ts %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-transform/app.module.ts hidden %}
   * {% embed_file shared/main.ts hidden %}
   * {% endmeta %}
   * {% endplatform_content %}
   * {% platform_content react %}
   * {% meta %}
   * {% embed_file element-transform/app.tsx preview %}
   * {% embed_file element-transform/main.tsx %}
   * {% embed_file element-transform/draw-scene.js %}
   * {% endmeta %}
   * {% endplatform_content %}
   *
   ...
   * {% platform_content angular %}
   * {% meta %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-visibility/draw-scene.ts %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-visibility/app.component.ts %}
   * {% embed_file drawing-dom-elements/customizing-the-appearance/element-visibility/app.module.ts hidden %}
   * {% embed_file shared/main.ts hidden %}
   * {% endmeta %}
   * {% endplatform_content %}
   * {% platform_content react %}
   * {% meta %}
   * {% embed_file element-visibility/app.tsx preview %}
   * {% embed_file element-visibility/main.tsx %}
   * {% embed_file element-visibility/draw-scene.js %}
   * {% endmeta %}
   * {% endplatform_content %}
   *
