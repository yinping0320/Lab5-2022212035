 ...
 * {% meta height:250 %}
 * {% embed_file exporting-drawings-to-images/export-scene.ts preview %}
 * {% embed_file exporting-drawings-to-images/app.component.ts %}
 * {% embed_file exporting-drawings-to-images/app.module.ts hidden %}
 * {% embed_file shared/main.ts hidden %}
 * {% endmeta %}
 * {% endplatform_content %}
 * {% platform_content react %}
 * {% meta height:250 %}
 * {% embed_file export-image/app.tsx preview %}
 * {% embed_file export-image/main.tsx %}
 * {% embed_file export-image/export-scene.js %}
 * {% endmeta %}
 * {% endplatform_content %}
 *
