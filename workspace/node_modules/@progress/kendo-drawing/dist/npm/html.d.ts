...
/**
 * Converts the given DOM element to a drawing scene ([see example](slug:drawingofhtmlelements_drawing)). The operation is asynchronous and returns a promise that will be resolved with the root `Group` of the scene.
 *
