...
function formatOffset(tzOffset) {
    ...
    var hours = pad_number_1.padNumber(Math.floor(value / 60));
    var minutes = pad_number_1.padNumber(value % 60);
...
var ZonedDate = /** @class */ (function () {
    ...
    ZonedDate.prototype.toTimeString = function () {
        var hours = pad_number_1.padNumber(this.getHours());
        var minutes = pad_number_1.padNumber(this.getMinutes());
        var seconds = pad_number_1.padNumber(this.getSeconds());
