...
export { DialogCloseResult, DialogRef, DialogSettings, DialogAction, DialogResult } from './dialog/dialog-settings';
...
export { WindowState, WindowSettings, WindowDimensionSetting, WindowRef, WindowCloseResult } from './window/window-settings';
