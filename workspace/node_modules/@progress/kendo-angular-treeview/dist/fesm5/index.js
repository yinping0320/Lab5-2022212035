...
var NavigationService = /** @class */ (function () {
    function NavigationService(localization) {
        ...
        this.navigable = true;
        this.actions = (_a = {}, _a[Keys.up] = function () { return _this.activate(_this.model.findPrev(_this.focusableItem)); }, _a[Keys.down] = function () { return _this.activate(_this.model.findNext(_this.focusableItem)); }, _a[Keys.left] = function () { return (_this.expand({
                expand: _this.localization.rtl,
                intercept: _this.localization.rtl ? _this.moveToChild : _this.moveToParent
            })); }, _a[Keys.right] = function () { return (_this.expand({
                expand: !_this.localization.rtl,
...
var TreeViewComponent = /** @class */ (function () {
    function TreeViewComponent(expandService, navigationService, nodeChildrenService, selectionService, treeViewLookupService, ngZone, renderer, element, dataChangeNotification, localization) {
         ...
         */
        this.children = function () { return of$1([]); };
        this.checkboxes = false;
        this.expandIcons = false;
        this.isActive = false;
        this.data = new BehaviorSubject$1([]);
        this._animate = true;
        this.subscriptions = new Subscription$1(function () { });
...
var TreeViewGroupComponent = /** @class */ (function () {
    ...
    TreeViewGroupComponent.prototype.fetchChildren = function (node, index) {
        ...
        return this.children(node)
            .pipe(catchError$1(function () {
            _this.loadingService.notifyLoaded(index);
            return empty$1();
        }), tap$1(function () { return _this.loadingService.notifyLoaded(index); }));
    };
...
var CheckDirective = /** @class */ (function () {
    function CheckDirective(treeView, zone) {
        ...
        this.subscriptions.add(this.treeView.childrenLoaded
            .pipe(filter$1(function () { return _this.options.checkChildren; }), switchMap$1(function (e) { return _this.zone.onStable.pipe(take$1(1), map$1(function () { return e; })); }))
...
var ExpandDirective = /** @class */ (function () {
    function ExpandDirective(treeView) {
        ...
        this.subscriptions = new Subscription$1(function () { });
        this._expandedKeys = [];
        this.subscriptions.add(merge$1(this.treeView.expand.pipe(map$1(function (e) { return (__assign({ expand: true }, e)); })), this.treeView.collapse.pipe(map$1(function (e) { return (__assign({ expand: false }, e)); }))).subscribe(this.toggleExpand.bind(this)));
...
var HierarchyBindingDirective = /** @class */ (function () {
    ...
    HierarchyBindingDirective.prototype.ngOnInit = function () {
        ...
        if (isPresent(this.childrenField)) {
            this.treeView.children = function (item) { return of$1(getter(_this.childrenField, true)(item)); };
...
var LoadingIndicatorDirective = /** @class */ (function () {
    ...
    LoadingIndicatorDirective.prototype.ngOnInit = function () {
        ...
        var loadingNotifications = this.loadingService
            .changes
            .pipe(filter$1(function (index) { return index === _this.index; }));
        this.subscription = this.expandService
            ...
            var expand = _a.expand;
            return expand;
        }), switchMap$1(function (x) { return of$1(x).pipe(delay$1(100), takeUntil$1(loadingNotifications)); }))
...
var FlatDataBindingDirective = /** @class */ (function () {
    ...
    FlatDataBindingDirective.prototype.ngOnInit = function () {
        ...
        if (isPresent(this.parentIdField) && isPresent(this.idField)) {
            ...
            this.treeView.children = function (node) { return of$1(fetchChildren_1(node)); };
        }
    };
    /**
     * @hidden
