...
var NavigationService = /** @class */ (function () {
    function NavigationService(localization) {
        ...
        this.navigable = true;
        this.actions = (_a = {},
            _a[keys_1.Keys.up] = function () { return _this.activate(_this.model.findPrev(_this.focusableItem)); },
            _a[keys_1.Keys.down] = function () { return _this.activate(_this.model.findNext(_this.focusableItem)); },
            _a[keys_1.Keys.left] = function () { return (_this.expand({
                expand: _this.localization.rtl,
                intercept: _this.localization.rtl ? _this.moveToChild : _this.moveToParent
            })); },
            _a[keys_1.Keys.right] = function () { return (_this.expand({
                expand: !_this.localization.rtl,
